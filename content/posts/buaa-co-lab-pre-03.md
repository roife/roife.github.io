...
{{< figure src="/img/in-post/post-buaa-co/mips-add-encode.png" caption="<span class=\"figure-number\">Figure 2: </span>Add instruction in machine code" width="500" >}}
...
将字节的最后两位去掉就可以得到对应的字，因此最后两位被称为**偏移**。
